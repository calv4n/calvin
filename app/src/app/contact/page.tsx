    ...
    return (
        ...
        >
            <div className="pointer-events-none select-none absolute inset-0 overflow-hidden">
                ...
                <div className="absolute -top-4 right-[-8%] w-[32%] md:w-[34%] h-60 md:h-95 bg-gradient-to-b bg-[#1c1c1c] rotate-[3deg] md:rotate-[3deg] shadow-2xl shadow-[#1c1c1c]/25 transform-gpu" />
            </div>
            ...
            <div className="relative max-w-7xl mx-auto">
                ...
                >
                    <div className="min-h-[calc(70vh-96px)] pt-8 md:pt-12">
                        <div>
                            <div>
                                <h1 className="text-5xl md:text-8xl font-bold m-5">LET'S BUILD</h1>
                            </div>
                            <div className="flex flex-row">
                                <h1 className="text-5xl md:text-8xl font-bold m-5">THE</h1>
                                <Highlighter action="highlight" color="#ffc700" animationDuration={1600} isView={true}>
                                    <h1 className="text-5xl md:text-8xl font-bold m-5">FUTURE</h1>
                                </Highlighter>
                            </div>
                        </div>
                    </div>
